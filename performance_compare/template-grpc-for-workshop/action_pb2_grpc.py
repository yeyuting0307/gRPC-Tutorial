...
class ToDoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.HealthCheck = channel.unary_unary(
                '/AiiiGRPC.ToDoService/HealthCheck',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=action__pb2.HealthCheckRes.FromString,
                )
...
def add_ToDoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'HealthCheck': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=action__pb2.HealthCheckRes.SerializeToString,
            ),
...
class ToDoService(object):
    ...
    def HealthCheck(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/AiiiGRPC.ToDoService/HealthCheck',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            action__pb2.HealthCheckRes.FromString,
